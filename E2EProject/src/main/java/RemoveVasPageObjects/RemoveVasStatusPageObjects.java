...
public class RemoveVasStatusPageObjects extends base {
	public WebDriver driver;
	private WebDriverWait wait;
	public RemoveVasStatusPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public String checkStatus(String Type) throws IOException, InterruptedException {
		...
		for (int i = 1; i <= 300; i++) {
			...
			if (StatusObject.getText().equalsIgnoreCase("completed")
				...
				getScreenshot("RemoveVas is "+StatusObject.getText(),Type);
				break;
			} else {
