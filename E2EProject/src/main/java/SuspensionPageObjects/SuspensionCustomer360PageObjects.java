...
public class SuspensionCustomer360PageObjects {
	public WebDriver driver;
	private WebDriverWait wait;

	public SuspensionCustomer360PageObjects(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@class='MuiListItemText-root']/span[text()='Suspension']")
