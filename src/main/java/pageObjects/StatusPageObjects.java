...
public class StatusPageObjects extends base{
	public WebDriver driver;
	public StatusPageObjects(WebDriver driver)
	{
		this.driver=driver;
	...
	public String checkStatus(String Type) throws IOException, InterruptedException
	{
		...
		for (int i = 1; i <= 300; i++) 
		{
			...
			if(StatusObject.getText().equalsIgnoreCase("completed") || StatusObject.getText().equalsIgnoreCase("failed"))
			{
				getScreenshot(StatusObject.getText(),Type);
				break;
			}
			else
			{
